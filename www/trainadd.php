...
$commandd = "add_train -i $add_trainid -n $add_stationnum -m $add_seatnum -s $add_stations -p $add_prices -x $add_starttime -t $add_traveltimes";
if($add_stopovertimes != "")
	$commandd = "$commandd -o $add_stopovertimes";
$commandd = "$commandd -d $add_saledate -y $add_type";
