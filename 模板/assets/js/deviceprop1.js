...
{
	document.getElementById('deviceprop1_total').innerHTML = '总共查询到<b>' + main_json[0].total_num +'</b>台电脑';
}
...
function deviceprop1_write_table(m)
{
	for(var i = 1; i <= m; i++)
	{
		...
		details.innerHTML = '<button class="btn btn-link" style="font-size:12px" onclick=deviceprop1_show_details(' + i + ');>详情</button>';
